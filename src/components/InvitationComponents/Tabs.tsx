...
// }> = ({ activeTab, setActiveTab, invitations }) => {
//     const tabs = [
//         { key: 'pending', label: 'Pending', count: invitations.filter(inv => inv.status.toLowerCase() === 'pending').length },
//         { key: 'accepted', label: 'Accepted', count: invitations.filter(inv => inv.status.toLowerCase() === 'accepted').length },
//         { key: 'rejected', label: 'Rejected', count: invitations.filter(inv => inv.status.toLowerCase() === 'rejected').length },
