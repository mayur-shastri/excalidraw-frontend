    ...
    useEffect(()=>{
        const getSessionFromStorage = async ()=>{
            ...
            if (session.data.session) {
                navigate('/'); // Redirect to dashboard if session exists
            }
        }
            ...
            <div className="relative min-h-screen flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    ...
                    <button
                        ...
                        className="absolute top-4 left-4 mb-8 flex items-center text-slate-400 hover:text-white transition-colors">
                    ...
                    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-300">
                                {isSignUp ? 'Choose a provider to sign-up.' : 'Choose a provider to sign-in.'}
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <button
                                ...
                                className="w-full bg-white hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
